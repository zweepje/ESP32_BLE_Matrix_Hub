//
// Created by zweepje on 25-11-2025.
//
/*
...
void initfs(void)
{
    ...
    ESP_LOGE(TAG, "Read from file: '%s'", line);

    ESP_LOGE(TAG, "Reading from flashed filesystem example.txt");
    ...
    ESP_LOGE(TAG, "LittleFS unmounted");
}